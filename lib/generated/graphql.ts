...
export type GetLatestPostsQuery = { __typename?: 'RootQuery', posts?: { __typename?: 'RootQueryToPostConnection', nodes: Array<{ __typename?: 'Post', id: string, title?: string | null, slug?: string | null, date?: string | null }> } | null };
...
export type GetPostBySlugQuery = { __typename?: 'RootQuery', postBy?: { __typename?: 'Post', id: string, title?: string | null, content?: string | null, date?: string | null, slug?: string | null } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetLatestPosts(variables: GetLatestPostsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetLatestPostsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetLatestPostsQuery>({ document: GetLatestPostsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetLatestPosts', 'query', variables);
    },
